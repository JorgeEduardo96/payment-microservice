...
public class SecurityConfig {
    ...
    /**
     * Same split as client-service/api-gateway: the frontend authenticates against Keycloak via
     * the browser-facing issuer (localhost:8180), but this service fetches signing keys via
     * Keycloak's internal Service DNS name.
     */
    @Bean
